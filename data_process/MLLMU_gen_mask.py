...
forget_ratio=15
forget_data_folder=f"data_split/baseline_train_split/forget_{forget_ratio}"
remain_data_folder=f"data_split/baseline_train_split/retain_{100-forget_ratio}"
...
label="ours"
folder=f"output_dir/forget{forget_ratio}"
