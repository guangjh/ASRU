...
def main():
    ...
    if not ray.is_initialized():
        ...
        # Ray will implicitly "auto-connect" to an existing cluster by reading
        # state files under /tmp/ray when address is omitted. That can lead to
        # surprising behavior (e.g. connecting to a stale cluster) even when
        # RAY_ADDRESS is unset. Default to a local Ray runtime unless the user
        # explicitly provides RAY_ADDRESS.
        ray_address = os.environ.get("RAY_ADDRESS") or "local"
